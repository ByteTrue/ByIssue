...
name: bi
description: >
  ByIssue：用 Vision / Project Spec / Epic / Issue 与 byissue/ 制度记忆理解和推进软件演化；按用户当前姿态行动——讨论、快改、受管理实现、修 bug、整理愿景/规格、理解现状、关闭收尾、按需 review。
  触发：bi、ByIssue、讨论/先聊清楚、快速/快改/直接开干、穿刺、修 bug/debug、整理 vision/spec、关闭/收尾、review、这系统怎么工作，或项目已有 byissue/ 且正在处理愿景、规格、bug、实现与关闭。
---
